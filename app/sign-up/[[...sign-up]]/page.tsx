      ...
      <div className="w-full  lg:w-1/2 flex flex-col gap-4 items-center">
        ...
        <SignUp.Root>
          <SignUp.Step name="start" className="flex flex-col gap-4">
            <Clerk.Connection
              name="google"
              className="bg-white rounded-full p-2 text-black w-72 flex items-center 
          ...
          <SignUp.Step name="verifications">
            <SignUp.Strategy name="email_code">
              ...
              <SignUp.Action
                submit
                className="mt-2 bg-iconBlue rounded-full p-2 text-white font-bold w-72 text-center"
              >
                Verify
              </SignUp.Action>
            </SignUp.Strategy>
